    ...
    <section id="review" class="review">
      <div class="container">
        ...
        <div class="section-title">
          <h2><span><br>Create</span> User Account</h2>
		...
		echo <<<_END
			<h5>
			<form action='usercreateaccount.php' method='post'>
			<pre>
				...
				<input type='hidden' name='role' id = 'role' value='U'>
			</form>
			<br>
			</h5>
		_END;
	  ...
	  <div class="container">
        ...
        <div class="section-title">
          <h3><span><br><br>Existing</span> User?</h3>
          <p><a href = "userloginpage.php">Sign In.</a></p>
