    ...
    <section id="review" class="review">
      <div class="container">
        ...
        <div class="section-title">
          <h2><span><br>Restaurant</span> Sign In</h2>
          <p>Please log in to access your restaurant!</p>
        </div>
		...
		echo <<<_END
		<h5>
		<form action='../authentication/restaurantauthentication.php' method='post'>
		<pre>	 
	  ...
	  <div class="container">
        ...
        <div class="section-title">
          <h3><span><br>New</span> Restaurant?</h3>
          <p><a href = "restaurantcreateaccount.php">Create a restaurant account.</a></p>
