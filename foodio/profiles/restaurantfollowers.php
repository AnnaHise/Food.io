    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h1><span><br>Follower List</h1>
		  <h2><span>Name<?php echo str_repeat('&nbsp;', 15);?>Email</h2> <h3></h3> 
		  <?php
				require_once '../dbinfo.php';

				$conn = new mysqli($hn, $un, $pw, $db);
				$restaurant = $_SESSION['restaurantID'];
				$query = "SELECT u.name, u.user_email from user as u inner join follow as f on u.user_ID = f.user_ID where f.restaurant_ID = $restaurant"; 
