    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h2><span><br>Edit User Review</span></h2>
		  <h4>
		  <?php
				...
				if(isset($_POST['reviewID'])){
					...
					// $result->data_seek($j); 
						...
						echo <<<_END
							...
							<pre>
						Subject: <input type='text' name='subject' value='$row[subject]'>
						Review: <input type='text' name='review' value='$row[review]'>
				...
				if(isset($_POST['update'])){
					...
					$query = "Update review set subject='$subject', review='$review', rating='$rating', review_date='$date' where review_ID = $id";
