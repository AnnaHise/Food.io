    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h2><span><br>Resaurant Information</span><br><br></h2>
		  <form action='adminaddrestaurant.php' method='post'>
			<input type='hidden' name='addrestaurant' value='yes'>
		  ...
		  <?php
				...
				echo <<<_END
					<p><br>Restaurant Name: $row[1]</p>
					<p>Owner Name: $row[5]<br></p>
					<p>Email: $row[7]<br></p>
					<p>Password: $row[2]<br></p>
					<p>Address: $row[4]<br></p>
					<p>Phone: $row[6]<br></p>
					<p>Description: $row[3]<br></p>
					<p>Type: $row[8]<br></p>
					<p>
					<form action='admineditrestaurantinfo.php' method='post'>
						<input type='hidden' name='editrestaurantinfo' value='yes'>
						<input type='hidden' name='restaurant' value='$row[0]'>
