    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h2><span><br>Edit Food Information</span></h2>
		  <h4>
		  <?php
				...
				if(isset($_POST['edit'])){
					...
					// $result->data_seek($j); 
						...
						echo <<<_END
							...
							<form action='editfooditem.php' method='post'>
							<pre>
						Name: <input type='text' name='name' value='$row[food_name]'>
						Description: <input type='text' name='description' value='$row[food_description]'>
						Type: <input type='text' name='type' value='$row[food_type]'>
				...
				if(isset($_POST['update'])){
					...
					$query = "Update food set food_name='$name', food_description='$description', food_type='$type', price='$price' where food_ID = $foodid";
