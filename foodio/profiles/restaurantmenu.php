    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h2><span><br>Restaurant Menu</span><br><br></h2>
		  ...
		  <?php
				...
				$query = "SELECT * from food where restaurant_ID = $restaurant";
				...
				<form action='addfooditem.php' method='post'>
					<input type='hidden' name='addfooditem' value='yes'>
				...
				for($j=0; $j<$rows; ++$j){
					...
					echo <<<_END
						...
						<form action='editfooditem.php' method='post'>
							...
							<input type='hidden' name='food' value='$row[0]'>
