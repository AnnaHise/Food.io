...
<body>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h1><span><br>My Reviews</h1>
		  <?php
				require_once '../dbinfo.php';

				$conn = new mysqli($hn, $un, $pw, $db);
				$userID = $_SESSION['userID'];
				$query = "select r.restaurant_name, re.subject, re.rating, re.review, re.review_date, re.review_ID
				from restaurant as r 
				inner join review as re on r.restaurant_ID=re.restaurant_ID
				inner join user as u on re.user_ID=u.user_ID
				...
				echo <<<_END
					...
					<h4>Review: $row[3]</h3>
					<h6>
					<form action='edituserreview.php' method='post'>
						<input type='hidden' name='editreview' value='yes'>
						<input type='hidden' name='reviewID' value='$row[5]'>
    ...
    </section><!-- End User Reviews Section -->
