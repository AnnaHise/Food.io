...
<body>
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="../profiles/redirect.php">Profile</a></li>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h1><span><br> Invalid Credentials. Authorization Denied.</h1>
		  <p>Please return to the login page.</p>
		  <h2><a href = "../login/userloginpage.php"><br>Login Page</a></h2>
    ...
    </section><!-- End Return to Login Section -->
